...
const lobby_music = "https://soundimage.org/wp-content/uploads/2018/10/Our-Mountain_v003_Looping.mp3";
const night_music = "http://soundimage.org/wp-content/uploads/2016/01/The-Castle-Beyond-the-Forest_Looping.mp3";
...
const soundtracks = dict(
    ...
    [Phases.DAY_CALLOUTS, {
        url: "http://soundimage.org/wp-content/uploads/2014/12/Drinking-Alone.mp3",
        loop: false,
        volume: 50
    }],
    ...
    [Phases.GAME_OVER, {
        url: "http://soundimage.org/wp-content/uploads/2016/07/RPG-Battle-Climax_v001.mp3",
        loop: true,
        volume: 40
    }],
)
